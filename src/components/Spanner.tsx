    ...
    <div className="w-screen overflow-hidden">
      <div className="w-[calc(200vw)] -translate-x-1/3 lg:-translate-x-1/4 flex flex-col gap-2 lg:gap-10 justify-center items-center text-xl lg:text-6xl xl:text-8xl dark:text-white py-10" ref={ref}>
        <motion.div 
          ...
          className="relative left-[7%] lg:-left-[10rem] basis-full shrink-0 flex flex-row items-center gap-10 mx-auto"
        >
          <ul className="underline col-start-1 shrink-0 flex flex-row items-center gap-4">
        ...
        <motion.div 
          initial={{ transform: `translateX(${hookedYPostion * -10}rem)` }}
          whileInView={{ transform: `translateX(${hookedYPostion * 10}rem)` }}
          className="relative left-[11%] lg:left-[5rem] basis-full shrink-0 flex flex-row gap-10 mx-auto"
        >
        ...
        <motion.div 
          ...
          className="relative left-[8%] lg:-left-[4rem] basis-full shrink-0 flex flex-row gap-10 mx-auto"
        >
          <ul className="underline col-start-3 shrink-0 flex flex-row items-center gap-4">
            <li>Teachers</li>
